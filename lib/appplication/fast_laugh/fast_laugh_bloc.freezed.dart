...
mixin _$FastLaughState {
  ...
  List<int> get likedVideoList => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      videoList: null == videoList
          ...
          : videoList // ignore: cast_nullable_to_non_nullable
              as List<Downloads>,
      likedVideoList: null == likedVideoList
          ? _value.likedVideoList
          : likedVideoList // ignore: cast_nullable_to_non_nullable
              as List<int>,
...
class _$_Initial implements _Initial {
  const _$_Initial(
      ...
      required final List<int> likedVideoList,
      required this.isLoading,
      required this.isError})
      : _videoList = videoList,
        _likedVideoList = likedVideoList;
  ...
  final List<int> _likedVideoList;
  @override
  List<int> get likedVideoList {
    if (_likedVideoList is EqualUnmodifiableListView) return _likedVideoList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_likedVideoList);
  }
  ...
  @override
  String toString() {
    return 'FastLaughState(videoList: $videoList, likedVideoList: $likedVideoList, isLoading: $isLoading, isError: $isError)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._likedVideoList, _likedVideoList) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_likedVideoList),
      isLoading,
      isError);
